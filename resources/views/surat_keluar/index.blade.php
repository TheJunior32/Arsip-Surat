...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <a href="{{ route('surat-keluar.index') }}" class="active"> Surat Keluar</a>
    </aside>
    ...
    <nav class="navbar navbar-light shadow-sm">
        <div class="d-flex align-items-center w-100">
            ...
            <form action="{{ route('surat-keluar.index') }}" method="GET" class="d-flex flex-grow-1" style="max-width: 450px;">
                <input type="search" name="search" placeholder="Cari surat keluar..." class="form-control search-box-pln"
                       value="{{ request('search') }}">

                @if(request('search'))
                    <a href="{{ route('surat-keluar.index') }}" class="btn btn-reset-pln ms-2">
                        Reset
                    </a>
                @endif
            </form>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="form-card-header">
                    <h5> Tambah Surat Keluar Baru</h5>
                </div>
                ...
                <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nomor_surat" class="form-control" required placeholder="Contoh: 001/SK/2024">
                        </div>
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <button type="submit" class="btn btn-pln-primary w-100">⚡ Simpan Surat</button>
                        </div>
                    </div>
                            ...
                            <td>
                                @if($surat->file_surat)
                                    <a href="{{ asset('storage/' . $surat->file_surat) }}" target="_blank"
                                       class="btn btn-sm btn-outline-pln">
                                         Lihat
                                    </a>
                                @else
